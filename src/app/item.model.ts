...
const items = [
  ['Cardboard', Tiers.RESOURCE, 0.24, 0.18],
  ['Concrete', Tiers.RESOURCE, 4.19, 3.14],
  ['Magnet', Tiers.RESOURCE, 5.68, 4.26],
  ['Metal', Tiers.RESOURCE, 3.40, 2.55],
  ['Paint', Tiers.RESOURCE, 2.26, 1.70],
  ['Plastic', Tiers.RESOURCE, 0.60, 0.45],
  ['Rare Metal', Tiers.RESOURCE, 7.81, 5.86],
  ['Rubber', Tiers.RESOURCE, 1.10, 0.83],
  ['Wire', Tiers.RESOURCE, 1.71, 1.28],
